...
function openGroup(g){
  hideContext();closeDirectInfo();stopAllTyping(); selected={type:'group',id:g.id,name:g.name}; clearUnread('group',g.id); closeGroupInfo(); sendPushActivity(); $('chatHead').classList.remove('homeHidden');
