...
## v47 group UX update
- Sidebar group rows have a stable vertical-dots quick menu on desktop and mobile.
- Delete Group is a true group deletion action, separate from Exit Group, and is admin-only.
- Clicking the group avatar in the chat header opens Group Details.
- Group admins can click members to Make admin/Remove admin and Remove member; regular members do not get those controls.
- Add people and animated Edit group name controls are available from Group Details.
- Notification control now uses an animated bell + on/off switch visual.
